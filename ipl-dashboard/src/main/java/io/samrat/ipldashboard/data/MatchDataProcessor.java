package io.samrat.ipldashboard.data;
...
import io.samrat.ipldashboard.model.Match;
...
public class MatchDataProcessor implements ItemProcessor<MatchInput, Match> {
  ...
  public Match process(final MatchInput matchInput) throws Exception {
    ...
    //Set team1 , team2 depending on the innings order . Who gets bats is team1 and other is team2
